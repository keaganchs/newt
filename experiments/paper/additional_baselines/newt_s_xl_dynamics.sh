...
# The dynamics model has to be manually changed in newt/tdmpc2/common/layers.py
# This script is intended to test mlp(latent_dim + action_dim + task_dim, [512, 512], latent_dim)
