...
# L_layers sweep: SimpleTRM @1h1l, latent_dim=16, L_layers=8.
...
# group: abl_l_layers/smp_16ld_1h1l_8L  (3 seeds aggregate; filter by "abl_l_layers/" prefix for the plan)
