#!/bin/bash
#SBATCH --job-name=f6_nofilm_1h1l
...
# F6: use_film_dynamics=False @1h1l (SimpleTRM, low-recursion).
#
...
# group: abl_film/smp_384ld_1h1l_nofilm  (3 seeds aggregate; filter by "abl_film/" prefix for the plan)
