...
# F6: use_film_dynamics=True @1h1l (SimpleTRM, low-recursion).
#
...
# group: abl_film/smp_384ld_1h1l_film  (3 seeds aggregate; filter by "abl_film/" prefix for the plan)
