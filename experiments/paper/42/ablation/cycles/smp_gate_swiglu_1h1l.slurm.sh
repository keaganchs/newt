#!/bin/bash
#SBATCH --job-name=f3_swiglu_1h1l
...
# F3: gate swiglu @1h1l (SimpleTRM, low-recursion).
#
...
# group: abl_cycles_gate/smp_384ld_1h1l_swiglu  (3 seeds aggregate; filter by "abl_cycles_gate/" prefix for the plan)
