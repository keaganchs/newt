#!/bin/bash
#SBATCH --job-name=f3_additive_1h1l
...
# F3: gate additive @1h1l (SimpleTRM, low-recursion).
#
...
# group: abl_cycles_gate/smp_384ld_1h1l_additive  (3 seeds aggregate; filter by "abl_cycles_gate/" prefix for the plan)
