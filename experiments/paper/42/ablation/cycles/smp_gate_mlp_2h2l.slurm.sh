...
# F3: gate mlp @2h2l (SimpleTRM, low-recursion).
#
...
# group: abl_cycles_gate/smp_384ld_2h2l_mlp  (3 seeds aggregate; filter by "abl_cycles_gate/" prefix for the plan)
