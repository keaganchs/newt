#!/bin/bash
#SBATCH --job-name=f3_additive_2h2l
...
# F3: gate additive @2h2l (SimpleTRM, low-recursion).
#
...
# group: abl_cycles_gate/smp_384ld_2h2l_additive  (3 seeds aggregate; filter by "abl_cycles_gate/" prefix for the plan)
