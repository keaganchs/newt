...
# latent_dim sweep, SimpleTRM @1h1l, latent_dim=512 (low-recursion).
#
...
# group: abl_latent_dim_1h1l/smp_512ld_1h1l  (3 seeds aggregate; filter by "abl_latent_dim_1h1l/" prefix for the plan)
