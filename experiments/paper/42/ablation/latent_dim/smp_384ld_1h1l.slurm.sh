...
# latent_dim sweep, SimpleTRM @1h1l, latent_dim=384 (low-recursion).
#
...
# group: abl_latent_dim_1h1l/smp_384ld_1h1l  (3 seeds aggregate; filter by "abl_latent_dim_1h1l/" prefix for the plan)
