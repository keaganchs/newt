...
# F7: DIS loss on, linear schedule @4h3l, latent_dim=16 (SimpleTRM).
# Same cell as smp_dis.sh "smp_16ld_4h3l_dis_linear".
#
# 3090 cluster (SBATCH). Submit from the repo root:  sbatch <this file>
# 1 cell x 3 seeds share one GPU.
# group: abl_dis_loss/smp_16ld_4h3l_dis_linear  (3 seeds aggregate; filter by "abl_dis_loss/" prefix for the plan)
