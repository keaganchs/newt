...
# F4: (H,L)=(4,4) at fixed budget 16 (SimpleTRM). Extends the smp_hl.sh
...
# group: abl_h_vs_l/smp_384ld_4h4l  (3 seeds aggregate; filter by "abl_h_vs_l/" prefix for the plan)
