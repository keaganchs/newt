...
# ---- latent_dim=128, 1h1l (no recursion) ----
for SEED in "${SEEDS[@]}"; do
    python3 $PYTHON_SCRIPT \
        ...
        wandb_run_name="smp_s${SEED}_128ld_1h1l_simnorm" \
        wandb_group="paper_simple_128ld_1h1l" \
        enable_wandb=True \
        H_cycles=1 \
        L_cycles=1 \
        seed="$SEED" \
...
# ---- latent_dim=128, 4h3l (H_cycles=4, L_cycles=3) ----
for SEED in "${SEEDS[@]}"; do
    python3 $PYTHON_SCRIPT \
        task="dmcontrol" \
        num_envs=21 \
        ...
        wandb_project="TRM Dynamics" \
        wandb_entity="trm-dynamics" \
        wandb_run_name="smp_s${SEED}_128ld_4h3l_simnorm" \
        wandb_group="paper_simple_128ld_4h3l" \
        enable_wandb=True \
        H_cycles=4 \
        L_cycles=3 \
        seed="$SEED" \
