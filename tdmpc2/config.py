...
class Config:
	...
	wandb_run_name: Optional[str] = "dmc_trm_nontokenized"	# wandb run name (defaults to <seed>)
	...
	trm_tokenize: bool = False								# Whether to tokenize obs into patches; False = flat mode (obs+task concatenated, no attention/mixer)
